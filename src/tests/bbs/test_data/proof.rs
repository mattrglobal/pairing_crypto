...
pub(crate) fn test_data_proof_verify_invalid_parameters() -> [(
    ...
    let (_proof, _revealed_messages) = test_helper::proof_gen(
        &PublicKey::default(),
        &signature,
        header,
        ph,
    ...
    [
        (
            ...
            "1 message-generator, no hidden messages, no revealed messages",
        ),
        (
            (
                default_proof_1_hidden_message,
                key_pair.public_key,
                header,
                ph,
                create_generators_helper(0),
            ...
            "no message-generators, 1 hidden message, no revealed_messages",
        ),
        (
            (
                default_proof.clone(),
            ...
            "no message-generators, no hidden messages, 1 revealed message, ",
        ),
        (
            (
