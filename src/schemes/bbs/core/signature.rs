...
impl Signature {
        ...
        I: BbsInterfaceParameter,
    {
        ...
        let domain =
            compute_domain::<_, _, I>(PK, header, messages.len(), generators)?;
        ...
        let e = I::hash_to_e(&data_to_hash)?;
