...
fn profile_sign(c: &mut Criterion) {
    ...
    c.bench_function(
        ...
        |b| {
            b.iter(|| {
                sign::<_, ExpandMsgXmd<Sha256>>(&BbsSignRequest {
...
fn profile_verify(c: &mut Criterion) {
    ...
    let signature = sign::<_, ExpandMsgXmd<Sha256>>(&BbsSignRequest {
    ...
    c.bench_function(
        ...
        |b| {
            b.iter(|| {
                assert!(verify::<_, ExpandMsgXmd<Sha256>>(&BbsVerifyRequest {
                    public_key: black_box(&public_key),
                    header: black_box(Some(header)),
                    messages: black_box(Some(&messages[..])),
...
fn profile_proof_gen(c: &mut Criterion) {
    ...
    assert_eq!(
        verify::<_, ExpandMsgXmd<Sha256>>(&BbsVerifyRequest {
            public_key: &public_key,
            header: Some(header),
            messages: Some(messages.as_slice()),
            signature: &signature,
    ...
    c.bench_function(
        ...
        |b| {
            b.iter(|| {
                proof_gen::<_, ExpandMsgXmd<Sha256>>(&BbsProofGenRequest {
                    public_key: black_box(&public_key),
                    header: Some(header),
...
fn profile_proof_verify(c: &mut Criterion) {
    ...
    let proof = proof_gen::<_, ExpandMsgXmd<Sha256>>(&BbsProofGenRequest {
        public_key: &public_key,
        header: Some(header),
    ...
    c.bench_function(
        ...
        |b| {
            b.iter(|| {
                assert!(proof_verify::<_, ExpandMsgXmd<Sha256>>(
                    &BbsProofVerifyRequest {
                        public_key: black_box(&public_key),
                        header: Some(header),
