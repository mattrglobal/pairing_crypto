  ...
  describe("ciphersuites", () => {
    describe("bls12381", () => {
      describe("keyGen", () => {
        [
          {
            generateKeyFn: bbs.ciphersuites.bls12381.generateKeyPair,
            secretKeyLength: bbs.ciphersuites.bls12381.PRIVATE_KEY_LENGTH,
            publicKeyLength: bbs.ciphersuites.bls12381.PUBLIC_KEY_LENGTH,
            ikm: new Uint8Array(
              Buffer.from(
