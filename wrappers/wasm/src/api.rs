...
#[wasm_bindgen(js_name = bbs_ciphersuites_bls12381_generate_key_pair)]
pub async fn bbs_ciphersuites_bls12381_generate_key_pair(
    ikm: Vec<u8>,
    key_info: Vec<u8>,
...
#[wasm_bindgen(js_name = bbs_ciphersuites_bls12381_sign)]
pub async fn bbs_ciphersuites_bls12381_sign(
    request: JsValue,
...
#[wasm_bindgen(js_name = bbs_ciphersuites_bls12381_verify)]
pub async fn bbs_ciphersuites_bls12381_verify(
    request: JsValue,
) -> Result<JsValue, JsValue> {
    // Improves error output in JS based console.log() when built with debug
    // feature enabled
...
#[wasm_bindgen(js_name = bbs_ciphersuites_bls12381_derive_proof)]
pub async fn bbs_ciphersuites_bls12381_derive_proof(
    request: JsValue,
) -> Result<JsValue, serde_wasm_bindgen::Error> {
    // Improves error output in JS based console.log() when built with debug
    // feature enabled
...
///
/// Returned value is a byte array which is the produced proof (variable length)
#[wasm_bindgen(js_name = bbs_ciphersuites_bls12381_verify_proof)]
pub async fn bbs_ciphersuites_bls12381_verify_proof(
    request: JsValue,
) -> Result<JsValue, serde_wasm_bindgen::Error> {
    // Improves error output in JS based console.log() when built with debug
    // feature enabled
