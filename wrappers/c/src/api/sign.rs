...
#[no_mangle]
pub extern "C" fn bbs_ciphersuites_bls12381_sign_context_init(
    err: &mut ExternError,
) -> u64 {
...
set_byte_array_impl!(
    bbs_ciphersuites_bls12381_sign_context_set_secret_key,
    BBS_SIGN_CONTEXT,
    secret_key
);

set_byte_array_impl!(
    bbs_ciphersuites_bls12381_sign_context_set_public_key,
    BBS_SIGN_CONTEXT,
    public_key
);

set_byte_array_impl!(
    bbs_ciphersuites_bls12381_sign_context_set_header,
    BBS_SIGN_CONTEXT,
    header
);

add_byte_array_impl!(
    bbs_ciphersuites_bls12381_sign_context_add_message,
    BBS_SIGN_CONTEXT,
    messages
);

#[no_mangle]
pub extern "C" fn bbs_ciphersuites_bls12381_sign_context_finish(
    handle: u64,
...
define_handle_map_deleter!(
    BBS_SIGN_CONTEXT,
    bbs_ciphersuites_bls12381_sign_free
);
